...
FEATURES: Dict[str, List[Feature]] = {
    "code": [
        ...
        _f(r"\b(python|javascript|typescript|rust|golang|java|c\+\+|bash|shell|html|css|react|sql)\b",
           2.0, "names a programming language"),
    ...
    "reasoning": [
        _f(r"\b(why|how come|explain|reason|justify)\b", 1.5, "explanatory question"),
        _f(r"\b(compare|contrast|trade ?-?offs?|pros and cons|versus|vs\.?)\b", 2.2, "comparison request"),
        _f(r"\b(step[- ]by[- ]step|think through|analy[sz]e|evaluate|assess)\b", 2.2, "analysis request"),
